    ...
    db.transaction(function (tx) {
        tx.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name='words'", [], function (tx, res) {
            ...
            if (cnt == 0) {
                ...
                tx.executeSql(strInsertWords("hut - хижина"));
                tx.executeSql(strInsertWords("wanted - розыскивается"));
                tx.executeSql(strInsertWords("caretaker - хранитель"));
                tx.executeSql(strInsertWords("apprentice - стажер"));
                ...
                tx.executeSql(strInsertWords("on my own - сам"));
                tx.executeSql(strInsertWords("by my self - сам"));
                ...
                tx.executeSql(strInsertWords("obvious - очевидно"));
                ...
                tx.executeSql(strInsertWords("parcel - пакет, посылка"));
                tx.executeSql(strInsertWords("caretaker - смотритель, лицо, присматривающее за домом"));
                ...
                tx.executeSql(strInsertWords("chest-грудь"));
                ...
                tx.executeSql(strInsertWords("turned out - оказалось"));
                ...
                tx.executeSql(strInsertWords("degree - научная степень"));
                ...
                tx.executeSql(strInsertWords("appearance - внешность"));
                ...
                tx.executeSql(strInsertWords("hesitate - стесняйтесь"));
                tx.executeSql(strInsertWords("absence - отсутствие"));
                tx.executeSql(strInsertWords("pleasant - приятно"));
                tx.executeSql(strInsertWords("surprisingly - поразительно"));
                ...
                tx.executeSql(strInsertWords("arrangement - условие, расположение"));
                ...
                tx.executeSql(strInsertWords("avoid - избежать"));
                ...
                tx.executeSql(strInsertWords("parcel - посылка"));
                ...
                tx.executeSql(strInsertWords("degrees - градусы"));
                ...
                tx.executeSql(strInsertWords("degree - степень, уровень"));
                ...
                tx.executeSql(strInsertWords("arrangement - приведение в порядок"));
                ...
                tx.executeSql(strInsertWords("competition - соревнование"));
                ...
                //MEDICAL//////////////////////////////////////////////////////////////////////////////////////////////////////////////
                tx.executeSql(strInsertWords("survey - обследование"));
                ...
                tx.executeSql(strInsertWords("competition - конкуренция;  конкурсный экзамен "));
                ...
                tx.executeSql(strInsertWords("employee - работника"));
                ...
                tx.executeSql(strInsertWords("ought to - должен (моральные обязятельства)"));
                ...
                tx.executeSql(strInsertWords("to stick-stuck-stuck - втыкать, приклеивать"));
                ...
                tx.executeSql(strInsertWords("make up your mind - решиться"));
