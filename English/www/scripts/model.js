    ...
    db.transaction(function (tx) {
        tx.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name='words'", [], function (tx, res) {
            ...
            if (cnt == 0) {
                ...
                tx.executeSql(strInsertWords("to fry-overcook", "жарить-сверхготовьте"));
                ...
                tx.executeSql(strInsertWords("get rid of", "избавиться от"));
                ...
                tx.executeSql(strInsertWords("achieve", "достигать"));
                //-------------------------------------------------------------------------------------------------------------
